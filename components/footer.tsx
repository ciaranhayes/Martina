        ...
        <footer className="footer footer-horizontal footer-center bg-purple text-[#EFF0E2] p-10 mt-20">
            <aside>
                <div className="flex flex-row items-center gap-4">
                    <Image src="/logo-cream.svg" alt="logo" width={100} height={100} className="h-auto w-auto" />
                </div>
            ...
            <nav>
                <div className="grid grid-flow-col gap-4">
                    <a href="https://www.facebook.com/profile.php?id=100009726851505">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 71 72"
                            fill="none">
                            <path
                    ...
                    <a href="https://www.instagram.com/martinarosariaoconnell/">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 71 72"
                            fill="none">
                            <path
                    ...
                    <a href="https://www.youtube.com/@martinarosariaoconnell">
                    ...
                    <a href="https://www.linkedin.com/in/martina-rosaria-o-connell-a7b72827a">
